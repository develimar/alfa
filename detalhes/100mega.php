    ...
    <div class="container">
        ...
        <div class="row">
            <div class="sections-title">
                ...
                <p>Fibra: 100 Mega <br>R$ 89,90/mês.</p>
            </div><!-- End sections-title -->
        </div><!-- End row -->

        <div class="row">
            <div class="sections-title">
                <div class="sections-title-h3"><h3>Desconto de R$ 89,90</h3></div>
                <p>Plano mensal reduzido em R$ 179,80/mês.<br> O desconto é válido por tempo indeterminado.</p>
            </div><!-- End sections-title -->
        </div><!-- End row -->
