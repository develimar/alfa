...
<div id="wrap" class="fixed-enabled grid_1200">
    ...
    <header id="header-top">
        <div class="container clearfix">
            <div class="row">
                <div class="col-md-6">
                    <div class="phone-email"><i class="fa fa-phone"></i><b>31 3774-2622 | 31 97167-0705</b></div>
                    <div class="phone-email phone-email-2"><i class="fa fa-envelope"></i><b>contato@alfainternet.com.br</b></div>
                </div>
    ...
    <header id="header" style="background-image: url('images/topo.png');background-repeat: no-repeat;">
        <div class="container clearfix">
            ...
            <nav class="navigation-footer">
                <ul>
                    <li><a href="#wrap" onMouseOver="this.style.color='#0A9FD8'" onMouseOut="this.style.color='#171717'" style="font-size: 13px; font-weight: bold">INÍCIO</a></li>
                    <li><a href="#services" onMouseOver="this.style.color='#0A9FD8'" onMouseOut="this.style.color='#171717'" style="font-size: 13px; font-weight: bold">PLANOS</a></li>
                    <li><a href="https://www.speedtest.net" onMouseOver="this.style.color='#0A9FD8'" onMouseOut="this.style.color='#171717'" style="font-size: 13px; font-weight: bold" target="_blank">TESTE DE VELOCIDADE</a></li>
<!--                    <li><a href="#our_team" onMouseOver="this.style.color='#0A9FD8'" onMouseOut="this.style.color='#171717'" style="font-size: 13px; font-weight: bold">CONTRATO</a></li>-->
            ...
            <div class="tp-banner">
                <ul>
                    <li data-transition="random" data-slotamount="7" data-masterspeed="1500">
                        <!-- MAIN IMAGE -->
                        <img src="images/img01.jpg" alt="" data-bgfit="cover" data-bgposition="left top" data-bgrepeat="no-repeat">
                        ...
                        <div class="slide-h2 tp-caption randomrotate skewtoleft tp-resizeme start white"
                             ...
                             data-endspeed="300"
                             style="z-index: 2"><h2>Precisa de Internet ?</h2>
                        </div>
                        ...
                        <div class="slide-h3 tp-caption customin white"
                             ...
                             data-easing="Power3.easeInOut"
                             data-endspeed="300"
                             style="z-index: 2"><h2>Nós temos a solução!</h2>
                        </div>
                        ...
                        <div class="slide-p tp-caption black randomrotate skewtoleft tp-resizeme start"
                             ...
                             data-endspeed="500" style="z-index: 6;white-space: pre-line;max-width: 1170px;text-align: center;"><p class="white">Velocidade e qualidade para que sempre possamos atender os nossos clientes.</p>
                        </div>
                    ...
                    <li data-transition="random" data-slotamount="7" data-masterspeed="1000">
                        <!-- MAIN IMAGE -->
                        <img src="images/img02.jpg" alt="" data-bgfit="cover" data-bgposition="left top" data-bgrepeat="no-repeat">
                        ...
                        <div class="tp-caption color large_bg sfl start"
                             ...
                             data-speed="700"
                             data-easing="easeOutBounce"
                             style="z-index: 4">Levamos o melhor da tecnologia ate sua casa
                        </div>
                        ...
                        <div class="tp-caption color large_bg sft start"
                             ...
                             data-speed="700"
                             data-easing="easeOutBounce"
                             style="z-index: 4">Varias formas de acesso
                        </div>
                        ...
                        <div class="tp-caption color large_bg sfr start"
                             ...
                             data-speed="700"
                             data-easing="easeOutBounce"
                             style="z-index: 4">O mundo em suas Mãos!
                        </div>
                        ...
                        <div class="tp-caption color large_bg sft start"
                             ...
                             data-speed="700"
                             data-easing="easeOutBounce"
                             style="z-index: 4">Os melhores planos
                        </div>
                    </li>

                    <li data-transition="random" data-slotamount="7" data-masterspeed="1000">
                        <!-- MAIN IMAGE -->
                        <img src="images/img03.jpg" alt="" data-bgfit="cover" data-bgposition="left top" data-bgrepeat="no-repeat">
                        ...
                        <div class="slide-h2 tp-caption randomrotate skewtoleft tp-resizeme start white"
                             ...
                             data-easing="Power3.easeInOut"
                             data-endspeed="300"
                             style="z-index: 2"><h2>Seja Bem Vindo a Alfanet</h2>
                        </div>
    ...
    <div id="services" class="sections section-2">
        <div class="container">
<!--            <div class="sections-title">-->
<!--                <div class="sections-title-h3"><h3>Planos Via Rádio</h3></div>-->
<!--                <p>Temos planos e preços que se adaptam a sua necessidade, oferecendo qualidade dos serviços prestados.-->
<!--                    <br />Nossos planos proporcionam ao nossos clientes internet com a velocidade desejada e trafego ILIMITADO.-->
<!--                </p>-->
<!--            </div>-->
            <!-- End sections-title -->
            <div class="row">
...
<!--                    </div>-->
<!--                </div>-->
<!--                <div class="col-md-12 pricing-item">-->
<!--                    <div class="pricing-tables">-->
<!--                        <div class="pricing-header">-->
<!--                            <div><span>R$ 79,90</span></div>-->
<!--                            <h3>5 MEGA</h3>-->
<!--                        </div>-->
<!--                        <div class="pricing-content">-->
<!--                            <ul>-->
...
<!--            <br />-->
                ...
                <div class="sections-title">
                    <div class="sections-title-h3"><h3>Planos Fibra Óptica</h3></div>
                    <p>Temos planos e preços que se adaptam a sua necessidade, oferecendo qualidade dos serviços prestados.
                        <br />Nossos planos proporcionam ao nossos clientes internet com a velocidade desejada e trafego ILIMITADO.
                    </p>
...
<!--                    </div>-->
                    <div class="col-md-4 pricing-item">
                        <div class="pricing-tables">
                            <div class="pricing-header">
                                <small>de </small><strike> R$ 179,90</strike>
                                    <h4>por apenas</h4>
                                <div><span><b>R$ 89,90</b></span> mensal</div>
                                <h3>100 MEGA</h3>
                            </div>
                            <div class="pricing-content">
                                <ul>
                    ...
                    </div><div class="col-md-4 pricing-item">
                        <div class="pricing-tables">
                            <div class="pricing-header">
                                <small>de </small><strike> R$ 199,90</strike>
                                    <h4>por apenas</h4>
                        ...
                        <div class="pricing-tables">
                            <div class="pricing-header">
                                <small>de </small><strike> R$ 259,90</strike>
                                    <h4>por apenas</h4>
                                <div><span><b>R$ 129,90</b></span> mensal</div>
                                <h3>400 MEGA</h3>
                            </div>
                            <div class="pricing-content">
                                <ul>
...
<!--            <div class="sections-title">-->
<!--                <div class="sections-title-h3"><h3>Planos DSL</h3></div>-->
<!--            </div>-->
<!--            <div class="row">-->
<!--                <div class="col-md-2 pricing-item">-->
<!--                    <div class="pricing-tables">-->
<!--                        <div class="pricing-header">-->
<!--                            <div><span>R$ 49,90</span></div>-->
<!--                            <h3>1 MEGA</h3>-->
<!--                        </div>-->
<!--                        <div class="pricing-content">-->
<!--                            <ul>-->
...
<!--    <div id="about_us" class="sections sections-padding-b-50">-->
<!--        <div class="container">-->
<!--            <div class="sections-title">-->
<!--                <div class="sections-title-h3"><h3>Chat Online</h3></div>-->
<!--                <p>A Alfanet é uma empresa de tecnologia voltada para o ramo de-->
<!--                    provimento de acesso a internet,<br /> oferecendo aos nossos clientes o-->
<!--                    melhor da internet com a qualidade e entrega que só a Alfanet tem!</p>-->
<!--            </div>-->
            <!-- End sections-title -->
            <!--			<div class="row">-->
            <!--				<div class="col-md-6">-->
            ...
            <!--						    <h4 class="accordion-title active"><a href="#">História<i class="fa fa-plus"></i></a></h4>-->
            ...
            <!--					    </div>-->
            <!--					    <div class="section-content">-->
            <!--						    <h4 class="accordion-title"><a href="#">Missão<i class="fa fa-minus"></i></a></h4>-->
            <!--						    <div class="accordion-inner">-->
            <!--						        Duis dapibus aliquam mi, eget euismod scelerisque ut. Vivamus at elit quis urna adipiscing , Curabitur vitae velit in neque dictum blandit. Duis dapibus aliquam mi, eget euismod sceler ut.Duis dapibus aliquam mi, eget euismod scelerisque at elit quis urna adipiscing , Curabitur vitae velit in neque dictum blandit. Duis dapibus aliquam mi, eget euismod sceler ut.-->
            <!--						    </div>-->
            <!--					    </div>-->
            <!--					    <div class="section-content">-->
            <!--						    <h4 class="accordion-title"><a href="#">Futuro<i class="fa fa-minus"></i></a></h4>-->
            <!--						    <div class="accordion-inner">-->
            <!--						        Duis dapibus aliquam mi, eget euismod scelerisque ut. Vivamus at elit quis urna adipiscing , Curabitur vitae velit in neque dictum blandit. Duis dapibus aliquam mi, eget euismod sceler ut.Duis dapibus aliquam mi, eget euismod scelerisque at elit quis urna adipiscing , Curabitur vitae velit in neque dictum blandit. Duis dapibus aliquam mi, eget euismod sceler ut.-->
            <!--						    </div>-->
            <!--					    </div>-->
            ...
            <!--						    <span class="progressbar-title">Qualidade<span>100%</span></span>-->
            <!--						    <div class="progressbar-all">-->
            <!--						        <div class="progressbar-percent" style="background-color: #e03e25;" data-percent="100"></div>-->
            <!--					        </div>-->
            <!--					    </div>-->
            <!--					    <div class="progressbar">-->
            <!--						    <span class="progressbar-title">Velodiade<span>100%</span></span>-->
            <!--						    <div class="progressbar-all">-->
            <!--						        <div class="progressbar-percent" style="background-color: #e03e25;" data-percent="100"></div>-->
            <!--					        </div>-->
            <!--					    </div>-->
            <!--					    <div class="progressbar">-->
            <!--						    <span class="progressbar-title">Entrega<span>100%</span></span>-->
            <!--						    <div class="progressbar-all">-->
            <!--					        	<div class="progressbar-percent" style="background-color: #e03e25;" data-percent="100"></div>-->
            <!--					        </div>-->
            <!--					    </div>-->
            <!--					    <div class="progressbar">-->
            <!--						    <span class="progressbar-title">Garantia<span>100%</span></span>-->
            <!--						    <div class="progressbar-all">-->
            <!--						        <div class="progressbar-percent" style="background-color: #e03e25;" data-percent="100"></div>-->
            <!--					        </div>-->
            <!--					    </div>-->
            <!--					    <div class="progressbar">-->
            <!--						    <span class="progressbar-title">Suporte<span>100%</span></span>-->
            <!--						    <div class="progressbar-all">-->
            <!--						        <div class="progressbar-percent" style="background-color: #e03e25;" data-percent="100"></div>-->
            <!--					        </div>-->
            <!--					    </div>-->
...
<!--        <div class="container">-->
<!--            <div class="sections-title">-->
<!--                <div class="sections-title-h3"><h3>Contrato Prestação de Serviço</h3></div>-->
<!--                <p>Abaixo acesso ao nosso contrato de prestação de serviço para melhor atende-lo.</p>-->
<!--</div>-->

<!--        </div>-->
<!--    </div>/-->

    <div id="contact_us" class="sections sections-padding-b-0">
        <div class="container">
            <div class="row">
...
<!--                        <div class="widget-title"><h6>Acesse nossas Redes Sociais</h6></div>-->
...
<!-- End footer -->
    <footer id="footer-bottom">
        <div class="container">
            <div class="copyrights">Copyright 2021 | Designer By <a target="_blank" href="">EsDesigner</a> | Developer By <a target="_blank" href="">EsDesigner</a></div>
            <nav class="navigation-footer">
                <ul>
                    <li><a href="#wrap">Inicio</a></li>
...
<!--                    <li><a href="#about_us">Quem Somos</a></li>-->
                    ...
                    <li><a href="#our_team">Contrato</a></li>
                    <li><a href="http://177.129.189.202/radiusnet/cda/" target="_blank">Central do Assinante</a></li>
                    <!--<li><a href="#blog">Blog</a></li>-->
                    <li><a href="#contact_us">Contato</a></li>
                    <!--<li class="out-button"><a href="shortcodes.html">Shortcodes</a></li>-->
                </ul>
            </nav>
        </div><!-- End container -->
